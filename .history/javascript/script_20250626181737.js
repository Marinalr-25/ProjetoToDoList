document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('click', (e) => {
    ...
    if (botaoEdit) {
      ...
      function definirCorPrioridade() {
        popupEditarPrioridade.classList.remove('high', 'medium', 'low');
        if (prioridadeCard.innerText === 'Alta prioridade') {
          popupEditarPrioridade.classList.add('high');
        } else if (prioridadeCard.innerText === 'Prioridade média') {
          popupEditarPrioridade.classList.add('medium');
        } else if (prioridadeCard.innerText === 'Baixa prioridade') {
          popupEditarPrioridade.classList.add('low');
        } else {
          console.log('Nao encontrei a prioridade');
        }
      }

      definirCorPrioridade();
